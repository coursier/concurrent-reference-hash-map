// from https://github.com/hazelcast/hazelcast/blob/bacfd050453824df221393be89b847beeec50ce0/hazelcast/src/main/java/com/hazelcast/internal/util/ConcurrentReferenceHashMap.java
 ...
 *
 *
 * Retrieval operations (including {@code get}) generally do not block, so they
...
public class ConcurrentReferenceHashMap<K, V> extends AbstractMap<K, V>
        implements IConcurrentMap<K, V>, Serializable {
    ...
    // from https://github.com/hazelcast/hazelcast/blob/bacfd050453824df221393be89b847beeec50ce0/hazelcast/src/main/java/com/hazelcast/internal/util/Preconditions.java#L83-L95
    /**
